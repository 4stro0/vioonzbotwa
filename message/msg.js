	...
	try {
		...
		switch(command) {
			...
			case prefix+'help':
			    ...
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync(setting.pathimg) }, templateButtons: buttonsDefault, footer: 'Adit © 2022', mentions: [sender] })
				break
			case prefix+'runtime':
            ...
            case prefix+'cekpremium':
                if (!isPremium) return reply(`Kamu bukan user premium, makanya beli bangg , contact aja owner nya nanti tinggal transfer`)
                if (isOwner) return reply(`kamyu adalah majikan saya tuan`)
 ...
 *${prefix}getvideo <no urutan>*
 Untuk mengambil Audio/Video dari hasil pencarian`
			...
			case prefix+'ceklimit': case prefix+'cekbalance':
				...
				break
				case prefix+'tentangbot' :
					reply(`
					[Tentang Bot]
					Bot Dibuat Oleh *Vion* _aka_ Adit

					Dibuat Pada Tanggal 7 September (2 Minggu Pengerjaan Bot)
					Menggunakan Javascript , NodeJS , Wa API , Baileys

					[Tentang Owner]
					Owner Dari Bot Ini Tinggal Di Balikpapan
					Saya Masih Berusia 14 tahun
					saya belajar pemograman secara otodidak selama 7 bulan
					dan saya merasa saya mempunyai bakat di bidang ini , jadi saya meneruskan nya hingga saya tergabung dalah organisasi @9MercyDev
					`)
			default:
			if (!isGroup && isCmd) {
